...
#import bevy_solari::sampling::{generate_light_tree_sample, trace_light_visibility, calculate_resolved_light_contribution}
...
const DIRECT_LIGHT_SAMPLE_COUNT: u32 = 2u;
